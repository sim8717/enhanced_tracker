...
def gate_cost_matrix(
    ...
    measurements = np.asarray(
        ...
        # [detections[i].to_xywh() for i in detection_indices])########### 0820
        # [detections[i].to_xyas() for i in detection_indices])########### 0821
        # [detections[i].to_xysh() for i in detection_indices])########### 0821
    for row, track_idx in enumerate(track_indices):
