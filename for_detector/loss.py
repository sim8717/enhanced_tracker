    ...
    def __call__(self, p, targets):  # predictions, targets
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n_labels:
                ...
                iou = bbox_iou(pbox, tbox[i], GIoU=True).squeeze()  # iou(prediction, target) #######siou로 수정
    ...
    def __call__(self, p, targets):  # predictions, targets
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n_labels:
                ...
                iou = bbox_iou(pbox, tbox[i], GIoU=True).squeeze()  # iou(predicted_box, target_box)    ######################여기도 siou로 수정
